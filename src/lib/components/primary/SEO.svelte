<script lang="ts">
	...
	export let ogImage: string = 'https://milton-dc-story.netlify.app/sharecard.jpg';
...
<svelte:head>
	...
	<meta property="og:image" content="https://milton-dc-story.netlify.app/sharecard.jpg" />
